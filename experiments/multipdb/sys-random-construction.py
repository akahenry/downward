...
CONFIGS = [
    ...
    for index, (h_nick, h) in enumerate(
        [
            ("1", "lsh(patterns=systematic(4), n=1)"),
            ("5", "lsh(patterns=systematic(4), n=5)"),
            ("10", "lsh(patterns=systematic(4), n=10)"),
            ("15", "lsh(patterns=systematic(4), n=15)"),
            ("20", "lsh(patterns=systematic(4), n=20)"),
        ],
        start=1,
    )
]
