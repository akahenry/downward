...
CONFIGS = [
    ...
    for index, (h_nick, h) in enumerate(
        [
            ("lsh-sys2-normal", "lsh(patterns=systematic(1), transform=adapt_costs(cost_type=NORMAL))"),
            ("lsh-sys2-normal", "lsh(patterns=systematic(1), transform=adapt_costs(cost_type=ONE))"),
        ],
        start=1,
    )
]
