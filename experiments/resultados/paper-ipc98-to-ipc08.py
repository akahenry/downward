...
SUITE = sorted(
    suites.suite_ipc98_to_ipc04_strips() +
    suites.suite_ipc06_strips() +
    suites.suite_ipc06_strips_compilations() +
...
CONFIGS = [
    ...
    for index, (h_nick, h) in enumerate(
        [
            ...
            ("lsh-sys2-one", "lsh(patterns=systematic(2), transform=adapt_costs(cost_type=ONE))"),
