...
CONFIGS = [
    ...
    for index, (h_nick, h) in enumerate(
        [
            ...
            ("sort", "lsh(patterns=systematic(4), n=1, decrement=iterative, op_order=sort, res_order=sort)"),
            ("random", "lsh(patterns=systematic(4), n=1, decrement=iterative, op_order=sort, res_order=random)"),
            ("default", "lsh(patterns=systematic(4), n=1, decrement=iterative, op_order=sort, res_order=default)"),
        ],
        start=1,
    )
]
