...
CONFIGS = [
    ...
    for index, (h_nick, h, cost) in enumerate(
        [
            ("alt-single-lsh-ff", "alt([single(lsh()), single(ff())])", "NORMAL"),
            ("pareto-lsh-ff", "pareto([lsh(), ff()])", "NORMAL"),
            ("type-based-lsh-ff", "type_based([lsh(), ff()])", "NORMAL"),

            ("alt-single-lsh-ff", "alt([single(lsh()), single(ff())])", "ONE"),
            ("pareto-lsh-ff", "pareto([lsh(), ff()])", "ONE"),
            ("type-based-lsh-ff", "type_based([lsh(), ff()])", "ONE"),
        ],
        start=1,
    )
]
